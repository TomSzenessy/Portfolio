const translations = {
	...
	de: {
		...
		hero_text:
			'<strong>Wirtschaftsinformatik-Student an der TUM</strong> in München. Ich liebe es, komplexe technische Probleme in einfache, ruhige Erlebnisse zu verwandeln.',
		hero_note:
			'Immer noch am Lernen, immer neugierig und dankbar für Möglichkeiten zur Zusammenarbeit.',
		...
		about_p2:
			'Heute studiere ich <strong>Wirtschaftsinformatik</strong> an der TUM, verbinde technische Tiefe mit echtem Nutzen. Ich schätze Teamarbeit und versuche Räume zu schaffen, in denen man frühe Ideen gerne teilt.',
		about_p3:
	...
	es: {
		...
		hero_text:
			'<strong>Estudiante de Informática de Gestión en la TUM</strong> en Múnich. Me encanta convertir problemas técnicos complejos en experiencias sencillas y tranquilas.',
		hero_note:
		...
		about_p2:
			'Hoy estudio <strong>Informática de Gestión</strong> en la TUM, conectando profundidad técnica con impacto real. Me importa el trabajo en equipo e intento crear espacios donde la gente se sienta cómoda compartiendo ideas temprano.',
		about_p3:
